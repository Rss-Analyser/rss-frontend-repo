...
def create_arrow_annotation(sentiment_index):
    arrow_color = "green" if sentiment_index > 0 else "red"
    arrow_symbol = "arrow-up" if sentiment_index > 0 else "arrow-down"
...
def plot_sentiment_index_in_grid(selected_indices):
    ...
    arrow_annotation = create_arrow_annotation(sentiment_index)
